...
function BusinessSignInForm(props){
    ...
    return(
        <>
            <form className="businessSignUp">
                ...
                <div className="underFormText">New Business?<span className="blueTextDefault" onClick={()=>{props.stateChanger('intro')}}> Create Account</span></div>
                <br />
