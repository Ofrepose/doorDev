...
function DeveloperSignUpForm(props){
    ...
    return(
        <>
            <form className="businessSignUp">
                ...
                <div className="underFormText">Existing User? <span className="blueTextDefault" onClick={()=>{props.stateChanger('dev')}}>Sign in</span></div>
                <br />
